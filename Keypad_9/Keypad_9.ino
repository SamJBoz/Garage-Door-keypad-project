...
//********** User variables *********************************************
int pinPointer = 0; //initallize pinPointer variable
...
String temp = ""; //temporary varibale used to compare strings
...
boolean checkPinCode(String pinCode){ //*********************************************
  temp = ""; //intialize compare variable
...
void initializeMaster(){ //**********************************************************************
  ...
  // write 'MAST1234' into first 8 bytes of EEProm memeory
  if (pinCode != "MAST") 
  {
...
// Function to earase all pinCodes by resetting the pinPointer to zero
void earasePinCodes() { // *******************************************************************
